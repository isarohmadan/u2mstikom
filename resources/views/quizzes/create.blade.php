...
@section('title', 'Buat Kuis - ' . $lesson->title)
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Buat Kuis Baru</h5>
                    <small class="text-muted">Untuk materi: {{ $lesson->title }}</small>
                </div>
                <a href="{{ route('lessons.show', $lesson) }}" class="btn btn-secondary btn-sm">
                    <i class="bi bi-arrow-left me-1"></i> Kembali
                </a>
            </div>
            <div class="card-body">
                <form action="{{ route('quizzes.store', $lesson) }}" method="POST" id="quizForm">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="allow_retry" name="allow_retry"
                                            value="1" {{ old('allow_retry', true) ? 'checked' : '' }}>
